 ...
 * This is a collection of routines that are necessary for implementing nonadiabatic quantum dynamics algorithms.
 * The routines accept and return std::shared_ptr to allow for chaining transformations of the data.
